...
export default class NaverMapView extends Component {
    constructor() {
        ...
        this.animateToTwoCoordinates = (c1, c2) => {
            this.dispatchViewManagerCommand("animateToTwoCoordinates", [
                c1,
                c2
            ]);
        };
        this.animateToCoordinates = (coords, bounds) => {
            this.dispatchViewManagerCommand("animateToCoordinates", [
                coords,
                bounds
            ]);
        };
            ...
            return Platform.select({
                ...
                android: () =>
                    UIManager.dispatchViewManagerCommand(
                        this.nodeHandle,
                        // @ts-ignore
                        UIManager.getViewManagerConfig("RNNaverMapView")
                            .Commands[command],
                        arg
                    ),
                ios: () =>
                    NativeModules[`RNNaverMapView`][command](
                        this.nodeHandle,
                        ...arg
                    )
            })();
    ...
    render() {
        ...
        const ViewClass = useTextureView
            ? RNNaverMapViewTexture
            : RNNaverMapView;
